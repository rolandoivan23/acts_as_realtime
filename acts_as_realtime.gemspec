Gem::Specification.new do |s|
  ...
  s.authors     = ["Rolando Vazquez"]
  s.email       = 'rolando.vazquez.23@gmail.com'
  s.files       = ["lib/acts_as_realtime.rb"]
  s.homepage    = 'https://github.com/rolandoivan23/acts_as_realtime'
  s.license     = 'MIT'
end